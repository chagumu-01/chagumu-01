...
**后端开发者 / 持续学习者 / Agent 探索者**

热爱构建稳定、高效的系统，正在探索 AI Agent 的无限可能。
...
[![Blog](https://img.shields.io/badge/Blog-534AB7?style=flat-square&logo=rss&logoColor=white)](https://chagumu.site/)
...
| 项目 | 描述 | 技术栈 |
|------|------|--------|
| [Agent-Notes](https://github.com/chagumu-01/Agent-Notes) | AI Agent 学习笔记系统，记录从零到一的探索历程 | Agent · 后端 · 笔记 |
| [javaProblems](https://github.com/chagumu-01/javaProblems) | 关与学习java过程中自己总结的问题 | java · 后端 · 笔记 |
| [Intelligent_Learning_Assistant](https://github.com/chagumu-01/Intelligent_Learning_Assistant) | 一个简单的AI学习助手 | 简单交互 |
| [gumu](https://github.com/chagumu-01/gumu) | 本地代码助手 | 终端执行 |
| [WanxAgent](https://github.com/chagumu-01/WanxAgent) | 网页交互 | MCP、多Agent |
